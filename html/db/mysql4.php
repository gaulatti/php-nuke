...
if(!defined("SQL_LAYER"))
{
	...
	//
		function sql_db($sqlserver, $sqluser, $sqlpassword, $database, $persistency = true)
		{
			...
			$this->db_connect_id = ($this->persistency) ? mysql_pconnect($this->server, $this->user, $this->password) : mysqli_connect($this->server, $this->user, $this->password);
	...
	//
		...
		function sql_fetchrowset($query_id = 0)
		{
			...
			if( $query_id )
			{
				...
				while($this->rowset[$query_id] = mysqli_fetch_array($query_id, MYSQL_ASSOC))
				{
